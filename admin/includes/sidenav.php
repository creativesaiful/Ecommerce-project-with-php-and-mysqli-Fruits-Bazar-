                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="add_product.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Add Prodcut</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="manage_order.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Manage Order</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
